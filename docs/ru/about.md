...
## Тестовое задание для стенда

Для улучшения визуализация текста можно использовать различные сценарии оформления: 
* базовая разметка
* списки
* таблицы
* фрагменты кода
...
#|
|| **Задание** | **Результат** ||
|| Оформите текст в столбце "Результат" курсивом | _Вы великолепны_ ||
|#
